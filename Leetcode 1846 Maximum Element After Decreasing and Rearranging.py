...
class Solution:
    def maximumElementAfterDecrementingAndRearranging(self, arr: List[int]) -> int:
        ...
        for x in arr[1:]:
            # Update the answer by taking the minimum of the current element and ans + 1
            ans = min(x, ans + 1)
...
arr = [2, 3, 1, 5]
solution = Solution()
print(f"Maximum element after decrementing and rearranging: {solution.maximumElementAfterDecrementingAndRearranging(arr)}")
