...
The event can be represented as a pair of integers start and end that represents a booking on the half-open interval [start, end), the
...
class MyCalendar:
    ...
    def book(self, start: int, end: int) -> bool:
        ...
        # Check if the new event can be added without overlap
        if low == len(self.calendar) or self.calendar[low][0] >= end:
