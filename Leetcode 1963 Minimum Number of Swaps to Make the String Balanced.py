...
class Solution:
    def minSwaps(self, s: str) -> int:
        balance = 0  # Tracks the current balance of brackets
        max_imbalance = 0  # Tracks the maximum imbalance at any point
        ...
        # The minimum number of swaps required is half the max imbalance (as one swap fixes two positions)
